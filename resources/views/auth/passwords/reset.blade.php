                ...
                <div class="card-body">
                    ...
                    <form role="form" action="{{ route('password.update') }}" method="post">
                        ...
                        <fieldset>
                            ...
                            <input class="form-control mb-3" placeholder="أعد كلمة المرور" name="password_confirmation" type="password" value="" required autocomplete="off">

                            <button type="submit" class="btn btn-lg btn-success btn-block mb-3">حفظ كلمة المرور الجديدة</button>
                        </fieldset>
                    </form>
